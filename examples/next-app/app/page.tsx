              ...
              items={[
                {
                  ...
                  label: "npm",
                  content: (
                    <CodeBlock code="npm install git+https://github.com/learners-superpumped/clawops-design-system.git#v0.5.2" />
                  ),
                },
                {
                  id: "pnpm",
                  label: "pnpm",
                  content: (
                    <CodeBlock code="pnpm add git+https://github.com/learners-superpumped/clawops-design-system.git#v0.5.2" />
                  ),
                },
                {
                  id: "yarn",
                  label: "yarn",
                  content: (
                    <CodeBlock code="yarn add git+https://github.com/learners-superpumped/clawops-design-system.git#v0.5.2" />
                  ),
                },
              ]}
            />
